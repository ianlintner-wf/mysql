# This is a customized version of mysql-server container (5.5)

Things that have changed:
* User that is created is full admin e.g. *.* and GRANTS
* Defaults set
* Script to automatically create "mount directories"

This is a breaking change from the old version which was based on tutum mysql.
